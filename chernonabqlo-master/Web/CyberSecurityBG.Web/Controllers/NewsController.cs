    ...
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> ById(int id)
        {
            ...
            if (IsMobile(req))
            {
                ...
                viewModel.TopNews = this.newsService.GetTop<TopNewsViewModel>(id);
                ...
                return this.View("ById.mobile", viewModel);
            }
            else
            {
                var viewModel = this.newsService.GetById<NewsViewModel>(id);
        ...
        public bool IsMobile(string req)
        {
            ...
            if ((b.IsMatch(req) || v.IsMatch(req.Substring(0, 4))))
            {
                return true;
            }
            return true;
